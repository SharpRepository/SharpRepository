...
namespace SharpRepository.ODataRepository.Linq.QueryGeneration
{
    public class ODataApiGeneratorQueryModelVisitor : QueryModelVisitorBase
    {
        ...
        public CommandData GetODataApiCommand()
        {
        ...
        private string GetODataApiExpression(Expression expression)
        {
            return ODataApiGeneratorExpressionTreeVisitor.GetODataApiExpression(expression);
        }
    }
}
